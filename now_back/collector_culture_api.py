...
async def run_culture_api_collection():
    print("🎭 [문체부API] 서울/제주 공연 수집 가동")
    ...
    if not items:
        print("⚠️ 수집된 공연 데이터가 없습니다.")
        return

    print(f"📦 총 {len(items)}개의 공연 데이터를 처리합니다.")
    ...
    print("✅ 문체부API 공연 수집 및 동기화 완료.")


if __name__ == "__main__":
    asyncio.run(run_culture_api_collection())
