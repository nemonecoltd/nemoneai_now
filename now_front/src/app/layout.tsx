...
export const metadata: Metadata = {
  ...
  title: {
    default: "당신 3시간의 알찬 설계, 지금 여기 | 성수·홍대·용산·강남 팝업·공연·축제",
    template: "%s | 지금 여기"
  },
  description: "지금 바로 이 시간 성수·홍대·용산·강남 팝업, 서울 공연·전시, 제주 문화행사, 전국 축제 정보를 한 눈에! AI-driven real-time guide for Seoul pop-ups, performances, Jeju cultural events, and festivals nationwide.",
  alternates: {
