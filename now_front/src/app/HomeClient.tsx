...
function Home({ initialAllPlaces }: { initialAllPlaces: any[] }) {
...
export default function HomeClient({ initialAllPlaces }: { initialAllPlaces: any[] }) {
  return <Home initialAllPlaces={initialAllPlaces} />;
}
